...
my %reports = (
  ...
  ABONENT_SRV           => "$main::var_dir/sorm/Fenix/ABONENT_SERVICE_" . $sufix,
  ABONENT_ADDR          => "$main::var_dir/sorm/Fenix/ABONENT_ADDRESS_" . $sufix,
  ...
  GATEWAY               => "$main::var_dir/sorm/Fenix/GATEWAYS_" . $sufix,
