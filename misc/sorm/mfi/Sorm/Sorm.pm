...
#Abonent_ident
users.id AS LOGIN,
if((users.company_id > 0 && representative != '' && companies.phone != ''), companies.phone, (SELECT value from users_contacts WHERE type_id=1 AND users_contacts.uid=users.uid LIMIT 1)) AS PHONE,
...
#Ищем совпадения, выпиливаем их
        ...
        defined($axbills_array{$entry->{id}}->{COMPANY_ID}) && defined($entry->{value}->{COMPANY_ID}) && $axbills_array{$entry->{id}}->{COMPANY_ID} ne $entry->{value}->{COMPANY_ID} ||
				...
				defined($axbills_array{$entry->{id}}->{PHONE_FAX}) && defined($entry->{value}->{PHONE_FAX}) && $axbills_array{$entry->{id}}->{PHONE_FAX} ne $entry->{value}->{PHONE_FAX})
				{
					...
					if ($abonent_created == 0)
					{
						...
						print Abonent "ID;REGION_ID;CONTRACT_DATE;CONTRACT;ACTUAL_FROM;ACTUAL_TO;ABONENT_TYPE;NAME_INFO_TYPE;FAMILY_NAME;GIVEN_NAME;INITIAL_NAME;UNSTRUCT_NAME;BIRTH_DATE;IDENT_CARD_TYPE_ID;IDENT_CARD_TYPE;IDENT_CARD_SERIAL;IDENT_CARD_NUMBER;IDENT_CARD_DESCRIPTION;IDENT_CARD_UNSTRUCT;BANK;BANK_ACCOUNT;FULL_NAME;INN;CONTACT;PHONE_FAX;STATUS;ATTACH;DETACH;NETWORK_TYPE;INTERNAL_ID1;INTERNAL_ID2\n";
						$abonent_created = 1;
					}

				#Удаление строки.Как старая, но с RECORD_ACTON=2.
        print Abonent "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{CONTRACT_DATE} 00:00:00;$entry->{value}->{CONTRACT};$entry->{value}->{ACTUAL_FROM};$entry->{value}->{ACTUAL_TO};$entry->{value}->{ABONENT_TYPE};1;;;;$entry->{value}->{UNSTRUCT_NAME};$entry->{value}->{BIRTH_DATE};0;1;;;;$entry->{value}->{IDENT_CARD_SERIAL}$entry->{value}->{IDENT_CARD_DESCRIPTION};$entry->{value}->{BANK};$entry->{value}->{BANK_ACCOUNT};$entry->{value}->{FULL_NAME};$entry->{value}->{INN};$entry->{value}->{CONTACT};$entry->{value}->{PHONE_FAX};$entry->{value}->{STATUS};$entry->{value}->{ATTACH};$entry->{value}->{DETACH};4;;\n";
        ...
        print Abonent "$entry->{value}->{ABONENT_ID};$region_id;$axbills_array{$entry->{id}}->{CONTRACT_DATE} 00:00:00;$axbills_array{$entry->{id}}->{CONTRACT_ID};$begin_time;$date_ended;$axbills_array{$entry->{id}}->{ABONENT_TYPE};1;;;;$axbills_array{$entry->{id}}->{UNSTRUCT_NAME};$axbills_array{$entry->{id}}->{BIRTH_DATE};0;1;;;;$axbills_array{$entry->{id}}->{IDENT_CARD_SERIAL}$axbills_array{$entry->{id}}->{IDENT_CARD_DESCRIPTION};$axbills_array{$entry->{id}}->{BANK};$axbills_array{$entry->{id}}->{BANK_ACCOUNT};$axbills_array{$entry->{id}}->{FULL_NAME};$axbills_array{$entry->{id}}->{INN};$axbills_array{$entry->{id}}->{CONTACT};$axbills_array{$entry->{id}}->{PHONE_FAX};$axbills_array{$entry->{id}}->{STATUS};$begin_time;$date_ended;4;;\n\n";
				...
				defined($axbills_array{$entry->{id}}->{APARTMENT}) && defined($entry->{value}->{APARTMENT}) && $axbills_array{$entry->{id}}->{APARTMENT} ne $entry->{value}->{APARTMENT})
				{
					...
					{
					open(Abonent_addr, ">$location_file/ABONENT_ADDRESS_$file.txt") || die;
					print Abonent_addr "ABONENT_ID;REGION_ID;ADDRESS_TYPE_ID;ADDRESS_TYPE;ZIP;COUNTRY;REGION;ZONE;CITY;STREET;BUILDING;BUILD_SECT;APARTMENT;UNSTRUCT_INFO;BEGIN_TIME;END_TIME;INTERNAL_ID1;INTERNAL_ID2\n";
                                        $abonent_addr_created = 1;
					}

				#Удаление строки.Как старая, но с RECORD_ACTON=2.
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$entry->{value}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$entry->{value}->{ABONENT_ADDR_BEGIN_TIME};$entry->{value}->{ABONENT_ADDR_END_TIME};;\n";
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$entry->{value}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$entry->{value}->{ABONENT_ADDR_BEGIN_TIME};$entry->{value}->{ABONENT_ADDR_END_TIME};;\n";

				#Запись копии старой строки, но с RECORD_ACTION=1 и END_TIME=$begin_time.
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$entry->{value}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$entry->{value}->{ABONENT_ADDR_BEGIN_TIME};$begin_time;;\n";
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;3;0;$entry->{value}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$entry->{value}->{ABONENT_ADDR_BEGIN_TIME};$begin_time;;\n";

				#Запись новой строки, с RECORD_ACTION=1 и BEGIN_TIME=$begin_time, END_TIME=$date_ended
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$axbills_array{$entry->{id}}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$axbills_array{$entry->{id}}->{CITY};$axbills_array{$entry->{id}}->{STREET};$axbills_array{$entry->{id}}->{BUILDING};;$axbills_array{$entry->{id}}->{APARTMENT};;$begin_time;$date_ended;;\n";
				print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;3;0;$axbills_array{$entry->{id}}->{ZIP};$entry->{value}->{COUNTRY};$entry->{value}->{REGION};$entry->{value}->{ZONE};$axbills_array{$entry->{id}}->{CITY};$axbills_array{$entry->{id}}->{STREET};$axbills_array{$entry->{id}}->{BUILDING};;$axbills_array{$entry->{id}}->{APARTMENT};;$begin_time;$date_ended;;\n";
				...
				defined($axbills_array{$entry->{id}}->{CONTRACT_ID}) && defined($entry->{value}->{CONTRACT}) && $axbills_array{$entry->{id}}->{CONTRACT_ID} ne $entry->{value}->{CONTRACT})
				{
					...
					{
					open(Abonent_srv, ">$location_file/ABONENT_SERVICE_$file.txt") || die;
					print Abonent_srv "ABONENT_ID;REGION_ID;ID;BEGIN_TIME;END_TIME;PARAMETER;INTERNAL_ID1;INTERNAL_ID2\n";
                                        $abonent_srv_created = 1;
					}

				#Удаление строки.Как старая, но с RECORD_ACTON=2.
				print Abonent_srv "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{TP_ID};$entry->{value}->{ABONENT_SRV_BEGIN_TIME};$entry->{value}->{ABONENT_ADDR_END_TIME};$entry->{value}->{PARAMETER};;\n";

				#Запись копии старой строки, но с RECORD_ACTION=1 и END_TIME=internet_main_updated.
				print Abonent_srv "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{TP_ID};$entry->{value}->{ABONENT_SRV_BEGIN_TIME};$axbills_array{$entry->{id}}->{internet_main_updated};$entry->{value}->{PARAMETER};;\n";

				#Запись новой строки, с RECORD_ACTION=1 и BEGIN_TIME=internet_main_updated, END_TIME=$date_ended
				print Abonent_srv "$entry->{value}->{ABONENT_ID};$region_id;$axbills_array{$entry->{id}}->{TP_ID};$axbills_array{$entry->{id}}->{internet_main_updated};$date_ended;$axbills_array{$entry->{id}}->{PARAMETER};;\n";
		...
		#			print "IDENT Changed ON $entry->{id}";
				#Удаление строки.Как старая, но с RECORD_ACTON=2.
				print Abonent_ident "$entry->{value}->{ABONENT_ID};$region_id;5;$entry->{value}->{PHONE};;;;;;;;;;;$entry->{value}->{LOGIN};$entry->{value}->{E_MAIL};;;;;0;$clean_hex_ip_old;;;;;;;;;$entry->{value}->{ABONENT_IDENT_BEGIN_TIME};$entry->{value}->{ABONENT_IDENT_END_TIME};;;;;;;;;;;;;;;;;;\n";

				#Запись копии старой строки, но с RECORD_ACTION=1 и END_TIME=$begin_time.
				print Abonent_ident "$entry->{value}->{ABONENT_ID};$region_id;5;$entry->{value}->{PHONE};;;;;;;;;;;$entry->{value}->{LOGIN};$entry->{value}->{E_MAIL};;;;;0;$clean_hex_ip_old;;;;;;;;;$entry->{value}->{ABONENT_IDENT_BEGIN_TIME};$begin_time;;;;;;;;;;;;;;;;;;\n";

				#Запись новой строки, с RECORD_ACTION=1 и BEGIN_TIME=$begin_time, END_TIME=$date_ended
				print Abonent_ident "$entry->{value}->{ABONENT_ID};$region_id;5;$axbills_array{$entry->{id}}->{PHONE};;;;;;;;;;;$axbills_array{$entry->{id}}->{LOGIN};$axbills_array{$entry->{id}}->{E_MAIL};;;;;0;$clean_hex_ip_new;;;;;;;;;$begin_time;$date_ended;;;;;;;;;;;;;;;;;;\n";
...
#Удаляем несуществующих абонентов
			...
			if ($entry->{value}->{IPV4_NTOA} ne '0.0.0.0')
                        ...
                        print Abonent "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{CONTRACT_DATE} 00:00:00;$entry->{value}->{CONTRACT_ID};$begin_time;$date_ended;$entry->{value}->{ABONENT_TYPE};1;;;;$entry->{value}->{UNSTRUCT_NAME};$entry->{value}->{BIRTH_DATE};0;1;;;;$entry->{value}->{IDENT_CARD_SERIAL}$entry->{value}->{IDENT_CARD_DESCRIPTION};$entry->{value}->{BANK};$entry->{value}->{BANK_ACCOUNT};$entry->{value}->{FULL_NAME};$entry->{value}->{INN};$entry->{value}->{CONTACT};$entry->{value}->{PHONE_FAX};$entry->{value}->{STATUS};$begin_time;$date_ended;4;;\n";
			                  print Abonent "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{CONTRACT_DATE} 00:00:00;$entry->{value}->{CONTRACT_ID};$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};$entry->{value}->{ABONENT_TYPE};1;;;;$entry->{value}->{UNSTRUCT_NAME};$entry->{value}->{BIRTH_DATE};0;1;;;;$entry->{value}->{IDENT_CARD_SERIAL}$entry->{value}->{IDENT_CARD_DESCRIPTION};$entry->{value}->{BANK};$entry->{value}->{BANK_ACCOUNT};$entry->{value}->{FULL_NAME};$entry->{value}->{INN};$entry->{value}->{CONTACT};$entry->{value}->{PHONE_FAX};$entry->{value}->{STATUS};$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};4;;\n";

                        print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$entry->{value}->{ZIP};$country;$region;$zone;$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$begin_time;$date_ended;;\n";
                        print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;0;0;$entry->{value}->{ZIP};$country;$region;$zone;$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};;\n";
                        print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;3;0;$entry->{value}->{ZIP};$country;$region;$zone;$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$begin_time;$date_ended;;\n";
                        print Abonent_addr "$entry->{value}->{ABONENT_ID};$region_id;3;0;$entry->{value}->{ZIP};$country;$region;$zone;$entry->{value}->{CITY};$entry->{value}->{STREET};$entry->{value}->{BUILDING};;$entry->{value}->{APARTMENT};;$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};;\n";

                        print Abonent_srv "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{TP_ID};$begin_time;$date_ended;$entry->{value}->{PARAMETER};;\n";
                        print Abonent_srv "$entry->{value}->{ABONENT_ID};$region_id;$entry->{value}->{TP_ID};$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};$entry->{value}->{PARAMETER};;\n";

                        print Abonent_ident "$entry->{value}->{ABONENT_ID};$region_id;5;$entry->{value}->{PHONE};;;;;;;;;;;$entry->{value}->{LOGIN};$entry->{value}->{E_MAIL};;;;;0;$clean_hex_ip_old;;;;;;;;;$begin_time;$date_ended;;;;;;;;;;;;;;;;;;\n";
                        print Abonent_ident "$entry->{value}->{ABONENT_ID};$region_id;5;$entry->{value}->{PHONE};;;;;;;;;;;$entry->{value}->{LOGIN};$entry->{value}->{E_MAIL};;;;;0;$clean_hex_ip_old;;;;;;;;;$begin_time;$entry->{value}->{CURRENT_TIMESTAMP_3};;;;;;;;;;;;;;;;;;\n";
...
#Новый абонент
		...
		if ($new_entry)
		{
			...
			print Abonent "$new_entry->{ABONENT_ID};$region_id;$new_entry->{CONTRACT_DATE} 00:00:00;$new_entry->{CONTRACT_ID};$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;$new_entry->{ABONENT_TYPE};1;;;;$new_entry->{UNSTRUCT_NAME};$new_entry->{BIRTH_DATE};0;1;;;;$new_entry->{IDENT_CARD_SERIAL}$new_entry->{IDENT_CARD_DESCRIPTION};$new_entry->{BANK};$new_entry->{BANK_ACCOUNT};$new_entry->{FULL_NAME};$new_entry->{INN};$new_entry->{CONTACT};$new_entry->{PHONE_FAX};$new_entry->{STATUS};$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;4;;\n";
			print Abonent_addr "$new_entry->{ABONENT_ID};$region_id;0;0;$new_entry->{ZIP};$country;$region;$zone;$new_entry->{CITY};$new_entry->{STREET};$new_entry->{BUILDING};;$new_entry->{APARTMENT};;$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;;\n";
			print Abonent_addr "$new_entry->{ABONENT_ID};$region_id;3;0;$new_entry->{ZIP};$country;$region;$zone;$new_entry->{CITY};$new_entry->{STREET};$new_entry->{BUILDING};;$new_entry->{APARTMENT};;$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;;\n";
			print Abonent_srv "$new_entry->{ABONENT_ID};$region_id;$new_entry->{TP_ID};$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;$new_entry->{PARAMETER};;\n";
			...
			print Abonent_ident "$new_entry->{ABONENT_ID};$region_id;5;$new_entry->{PHONE};;;;;;;;;;;$new_entry->{LOGIN};$new_entry->{E_MAIL};;;;;0;$clean_hex_ip_new;;;;;;;;;$new_entry->{CONTRACT_DATE} 00:00:00;$date_ended;;;;;;;;;;;;;;;;;;\n";
...
#Платежи из Абиллса
		...
		(SELECT value from users_contacts WHERE type_id=1 AND users_contacts.uid=payments.uid LIMIT 1) AS PHONE,
...
#        print Dumper \@new_p_entries;# if ($debug == '1');
        ...
        foreach my $new_entry (@new_p_entries)
        {
			...
			print Payments "83;$new_entry->{PAY_TYPE_ID};$new_entry->{PAYMENT_DATE};$new_entry->{AMOUNT};;$new_entry->{PHONE};$new_entry->{ACCOUNT};;;;;;;;;;;0;;;;;;;;;;0;0;$new_entry->{ZIP};$country;$region;$zone;$city;$street;$build;;$apart;;$region_id\n";
...
#Export to Files
	 ...
	 open(Gateway, ">$location_file/GATEWAYS_$file.txt") || die;
...
#Export to Files
         ...
         while(my $data = $sth->fetchrow_hashref())
         {
                print Supplementary "$data->{id};$data->{DESCRIPTION};$data->{BEGIN_TIME};2049-12-31 23:59:59;$data->{DESCRIPTION};$region_id\n";
         }
        return;
