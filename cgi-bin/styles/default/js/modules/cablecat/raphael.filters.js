...
(function(scope) {
  ...
  var FR = {
    ...
    Filter: function(id) {
      ...
      this.element.setAttribute("x", "-10%");
      this.element.setAttribute("y", "-10%");
  ...
  FR.Filter.prototype = {
    ...
    createPaper: function() {
      this.chainEffect("feTurbulence", {type: "fractalNoise", baseFrequency: "0.04", numOctaves: "5", result: 'noise'});
      var whiteLightSource = new FR.FilterEffect("feDistantLight", {azimuth: '45', elevation: '60'});
      this.chainEffect("feDiffuseLighting", {in: "noise", "lighting-color": "white", surfaceScale: "2"}, whiteLightSource);

      this.merge(this.getLastResult(), "SourceGraphic");
...
Raphael.el.paperEf = function(height) {
  this.getFilter().createPaper();
