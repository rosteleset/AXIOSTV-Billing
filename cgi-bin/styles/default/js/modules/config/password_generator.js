...
function generatePassword(options) {
  ...
  if (options.SYMBOLS) {
    ...
    return generatePasswordBySymbols(options);
  }
...
function generatePasswordBySymbols(props) {
  var pwdChars = props.SYMBOLS;
  var pwdLen = parseInt(props.LENGTH);

  var randPassword = Array(pwdLen).fill(pwdChars).map(
