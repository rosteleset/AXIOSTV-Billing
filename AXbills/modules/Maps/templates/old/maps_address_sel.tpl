...
<TR><TH colspan=2 class=form_title>_{ADDRESS}_</TH></TR>
<TR bgcolor='$_COLORS[2]'><TD>_{DISTRICTS}_:</TD><TD>
...
<TR bgcolor='_{COLORS}_[2]'><TD>_{ADDRESS_STREET}_:</TD><TD>
...
<TR bgcolor='$_COLORS[2]'><TD>_{ADDRESS_BUILD}_:</TD><TD>
<div><input id="p3" type="text" class="input" value="%ADDRESS_BUILD%" onkeyup="build()" onclick="hide_unhide('l3')"> 
<!-- <a href="javascript:openwindow('$SELF_URL?qindex=68&header=1')"  class=link_button>_{ADD}_</a> --> </div>
<div id="l3" class="lists"></div>
</TD></TR> 
<TR bgcolor='_{COLORS}_[2]'><TD>_{ADDRESS_FLAT}_:</TD><TD><input type=text name=ADDRESS_FLAT value='%ADDRESS_FLAT%' size=8></TD></TR>
<TR bgcolor='$_COLORS[2]'><TD colspan=2 align=right>%ADD_ADDRESS_LINK%</TD></TR>


<!-- <input type=submit name='' value='_{CHANGE}_' onclick="javascript:returnDate('Zone ID');"> -->