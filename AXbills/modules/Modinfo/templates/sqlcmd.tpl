...
<tr><td>_{ROWS}_:</td><td><input type=text name='ROWS' value='%ROWS%'></td></tr>
<tr bgcolor=$_COLORS[2]><td>_{SAVE}_:</td><td><input type=checkbox name='HISTORY' value='1'></td></tr>
<tr bgcolor=$_COLORS[2]><td>_{COMMENTS}_:</td><td><input type=text name='COMMENTS' value='%COMMENTS%' size=40></td></tr>
