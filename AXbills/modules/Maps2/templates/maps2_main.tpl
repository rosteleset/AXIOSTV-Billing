...
<link rel='stylesheet' href='/styles/default/css/modules/maps/new-maps.css'>
...
<script>
  ...
  if (document.getElementById('new_maps')) {
    ...
    putScriptInHead('general_requests_map', '/styles/default/js/maps/new-general-requests.js',
      putScriptInHead('new_maps', '/styles/default/js/maps/new-maps.js'));
  }
</script>